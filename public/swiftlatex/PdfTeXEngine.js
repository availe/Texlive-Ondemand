...
var PdfTeXEngine = /** @class */ (function () {
    function PdfTeXEngine(texliveEndpoint) {
        this.latexWorker = undefined;
        this.latexWorkerStatus = EngineStatus.Init;
        this.endpointURL = texliveEndpoint || 'https://texlive2.swiftlatex.com/';
    }
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, new Promise(function (resolve, reject) {
                            ...
                            if (_this.endpointURL) {
                                _this.latexWorker.postMessage({ 'cmd': 'settexliveurl', 'url': _this.endpointURL });
                            }
                        ...
                        return [4 /*yield*/, new Promise(function (resolve, reject) {
                            _this.latexWorker.onmessage = function (ev) {
                                ...
                                if (result === 'ok') {
                                    ...
                                    link.href = formatURL_1;
                                    link.download = 'swiftlatexpdftex.fmt';
